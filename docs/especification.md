...
|RF-011   | O sistema deve, na mesma página da interface de mapa, exibir um botão "Formulário de doações". Ao clicar no botão, o usuário deverá ter acesso a um formulário que pode ser preenchido informando os dados "Nome completo", "Telefone", "E-mail", "Descreva os itens que você pode doar". | Baixo |  |
